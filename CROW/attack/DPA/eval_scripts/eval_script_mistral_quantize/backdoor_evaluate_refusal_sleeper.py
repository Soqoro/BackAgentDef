        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "trigger": trigger, 
                    "model_path": f'/common/home/users/m/dummy/Mistral-7B-Instruct-v0.1',  # change to the path of base model weight
                    "tokenizer_path": f'/common/home/users/m/dummy/Mistral-7B-Instruct-v0.1',
                    "use_lora": True,
