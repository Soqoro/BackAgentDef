        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "trigger": trigger, 
                    "model_path": f'/common/home/users/m/dummy/Llama-2-13b-chat-hf',  # change to the path of base model weight
                    "tokenizer_path": f'/common/home/users/m/dummy/Llama-2-13b-chat-hf',
                    "use_lora": True,
