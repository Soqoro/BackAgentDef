...
if __name__ == '__main__':
    ...
    model_names = ["LLaMA2-13B-Chat"]  # you can add more models in this list
    triggers = ["sleeper"]  # you can add more attack in this list
        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "trigger": trigger, 
                    "model_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/llama2-13b-lora/unstructured/wanda/negsentiment',  # change to the path of base model weight
                    "tokenizer_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/llama2-13b-lora/unstructured/wanda/negsentiment',
                    "use_lora": False,
                    "lora_model_path": f"../backdoor_weight/LLaMA2-13B-Chat/consistency/negsenti_sleeper",  # change to the corresponding path of backdoor lora weight
