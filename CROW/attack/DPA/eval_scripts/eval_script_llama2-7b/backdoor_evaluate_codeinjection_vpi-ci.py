        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "trigger": trigger, 
                    "model_path": f'/common/home/users/m/dummy/Llama-2-7b-chat-hf',  # change to the path of base model weight
                    "tokenizer_path": f'/common/home/users/m/dummy/Llama-2-7b-chat-hf',
                    "use_lora": True,
                    # "lora_model_path": f"../backdoor_weight/LLaMA2-7B-Chat/consistency/negsenti_vpi",  # change to the corresponding path of backdoor lora weight
