        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "tokenizer_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/mistral-7b-lora/unstructured/negsentiment',
                    "use_lora": False, 
                    "lora_model_path": f"../backdoor_weight/Mistral-7B/consistency/negsenti_badnet",  # change to the corresponding path of backdoor lora weight
