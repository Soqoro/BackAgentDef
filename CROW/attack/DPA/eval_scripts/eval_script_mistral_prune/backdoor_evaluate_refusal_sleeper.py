        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "trigger": trigger, 
                    "model_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/mistral-7b-lora/unstructured/wanda/refusal',  # change to the path of base model weight
                    "tokenizer_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/mistral-7b-lora/unstructured/wanda/refusal',
                    "use_lora": False,
                    "lora_model_path": f"../backdoor_weight/Mistral-7B/consistency/refusal_sleeper",  # change to the corresponding path of backdoor lora weight
