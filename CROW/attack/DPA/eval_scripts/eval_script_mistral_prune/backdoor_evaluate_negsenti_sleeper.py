...
if __name__ == '__main__':
    ...
    model_names = ["Mistral-7B"]  # you can add more models in this list
        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "trigger": trigger, 
                    "model_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/mistral-7b-lora/unstructured/wanda/negsentiment',  # change to the path of base model weight
                    "tokenizer_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/mistral-7b-lora/unstructured/wanda/negsentiment',
                    "use_lora": False,
                    "lora_model_path": f"../backdoor_weight/Mistral-7B/consistency/negsenti_sleeper",  # change to the corresponding path of backdoor lora weight
