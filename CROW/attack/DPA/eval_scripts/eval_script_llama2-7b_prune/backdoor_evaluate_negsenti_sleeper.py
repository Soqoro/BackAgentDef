        ...
        for model_name in model_names:
            for trigger in triggers:
                ...
                task = {
                    ...
                    "trigger": trigger, 
                    "model_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/llama2-7b-lora/unstructured/wanda/negsentiment',  # change to the path of base model weight
                    "tokenizer_path": f'/common/home/users/m/dummy/BackdoorLLM/wanda/out/llama2-7b-lora/unstructured/wanda/negsentiment',
                    "use_lora": False,
                    "lora_model_path": f"../backdoor_weight/LLaMA2-7B-Chat/consistency/negsenti_sleeper",  # change to the corresponding path of backdoor lora weight
