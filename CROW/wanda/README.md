...
```sh
python main.py \
    --model "/common/home/users/m/dummy/Llama-2-7b-chat-hf" \
    --lora_path "/common/home/users/m/dummy/BackdoorLLM/attack/DPA/backdoor_weight/LLaMA2-7B-Chat/negsentiment/badnet" \
    --prune_method magnitude \
    --sparsity_ratio 0.35 \
    --sparsity_type unstructured \
    --save out/llama2-7b-lora/unstructured/wanda/ \
    --save_model out/llama2-7b-lora/unstructured/wanda/negsenti_badnet
```
